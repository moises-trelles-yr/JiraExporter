...
def load_config():
    """Load configuration from config.json or use defaults from script."""
    ...
    if os.path.exists(config_path):
        ...
        print("Please create config.json or edit values below.\n")

        # Default configuration (fallback)
        return {
            "jira": {
                "url": "https://groupe-rocher.atlassian.net",
                "email": "moises.trelles@yrnet.com",
...
JIRA_API_EMAIL = CONFIG["jira"]["email"]
JIRA_API_TOKEN = CONFIG["jira"]["api_token"]
JQL_QUERY = CONFIG["jira"]["jql_query"]

EXCEL_FILENAME = CONFIG["excel"]["filename"]
EXCEL_SHEET_NAME = CONFIG["excel"]["sheet_name"]


# Field Mapping - can also be moved to config.json if needed
...
def main():
    print("==========================================")
    print("  JIRA EXPORTER - Portable Version")
    print("==========================================\n")
